...
workflows and permission reads per write (0 or 1). The example starts four local
nodes with the Normal harness preset. It prepares independent BLS signers and
...
denial is a correctness failure. Read errors or deadlines remain visible as
