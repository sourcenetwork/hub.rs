use super::*;
use vera_permission::{PAGE_PROOF_BYTES, PrefixPageRequest};
...
fn pages_bind_selection_successors_and_complete_prefix_semantics() {
    ...
    tokio::Runner::new(tokio::Config::new().with_storage_directory(directory.path())).start(
        |context| async move {
            ...
            for module in [
                vera_permission::ModuleId::Acp,
                vera_permission::ModuleId::Bulletin,
                vera_permission::ModuleId::Vera,
                vera_permission::ModuleId::NativeNonce,
            ] {
